        ...
        <button className={`w-full h-full z-[100] flex`} >
            <button onClick={() => setDarkMode(false)} className="flex justify-center items-center w-1/2 h-full">
                <SunDim  onMouseEnter={ handleEnter}
                    onMouseLeave={handleExit} className="z-[101] text- hover:text-purple-600 dark:hover:text-sky-300 hover:scale-[0.90] active:scale-75 transition-all duration-[700ms] ease-in-out" size={"65%"} weight="thin" />
            </button>
