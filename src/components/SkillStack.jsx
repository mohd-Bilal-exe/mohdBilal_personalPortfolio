    ...
    return (
        <section className={`w-full h-full flex justify-between items-center ${isFade && "pointer-events-none grayscale opacity-10"} transition-all duration-300`}>
            ...
            <div id="Stack" className="w-1/2 h-full  flex items-center justify-center">
                <h1 className="ml-4 text-5xl smartphone:text-3xl  font-bold leading-tight">
                    <span className="block Pally ">Tech stack </span>
                    <span className="block text-lg smartphone:text-xs  mt-1 ml-3 smartphone:ml-0">
                    ...
                    <span className="block  text-xs tracking-tight ml-3 smartphone:ml-0">
                        (or so I say)
                    </span>
                </h1>

                <Arrow className="w-20 h-20 z-0 smartphone:hidden  absolute top-12  rotate-[18deg]  -translate-y-10 translate-x-40" />
            </div>
